...
public class shop_xysj extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //显示界面
        setContentView(R.layout.shop_xysj);
    ...
    protected void initView(){
        ...
        mRgGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int checkedId) {
                switch (checkedId) {
                    case R.id.pingjia_xysj://导航
                        setTabSelection(show_tab_pingjia);
                        break;
                    case R.id.menu_xysj://地图
                        setTabSelection(show_tab_caidanye);
                        break;
                    case R.id.shangjia_xysj://发现
    ...
    private void setTabSelection(int id) {    //根据传入的index参数来设置选中的tab页。
        ...
        switch (index) {
            ...
            case show_tab_caidanye://地图的fragment
                mRgGroup.check(R.id.menu_xysj);
                if (caidanye == null) {
                    caidanye = new caidanye();
                    Bundle bundle=new Bundle();
                    bundle.putString("Bno","2");
